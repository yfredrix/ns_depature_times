...
def test_parse_depatures():
    ...
    assert departure.departures[1234]["actualDateTime"] == datetime(2019,12,4,12,0,0,tzinfo=timezone(timedelta(hours=1)))
    assert departure.departures[1234]["plannedDateTime"] == datetime(2019,12,4,12,0,0,tzinfo=timezone(timedelta(hours=1)))
